      ...
      <SheetContent className='flex w-full flex-col gap-0 sm:max-w-lg'>
        ...
        {items.length === 0 ?
          <div className='flex flex-1 flex-col items-center justify-center text-center'>
            ...
            <h3 className='mt-4 text-lg font-medium text-zinc-900 dark:text-zinc-100'>Your cart is empty</h3>
        ...
        : <>
            ...
            <div className='flex-1 overflow-y-auto px-5'>
              <div className='space-y-2 divide-y divide-zinc-200 py-2 dark:divide-zinc-800'>
                {items.map((item) => (
