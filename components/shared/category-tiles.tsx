        ...
        <Link
          ...
          <div className='relative h-32 w-56 sm:h-56 sm:w-80'>
            ...
            <div className='absolute inset-x-0 bottom-0 p-4'>
              <span className='text-base font-semibold text-white drop-shadow-md'>All Products</span>
            </div>
          </div>
        </Link>
          ...
          return (
            <Link
              ...
              <div className='relative h-32 w-56 sm:h-56 sm:w-80'>
                ...
                {/* Category name */}
                <div className='absolute inset-x-0 bottom-0 p-4'>
                  <span className='text-base font-semibold text-white drop-shadow-md'>{category.title}</span>
                </div>
