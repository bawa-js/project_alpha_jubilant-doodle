...
export type Order = {
  ...
  orderNumber?: string
  items?: Array<{
    product?: { _ref: string; _type: 'reference'; _weak?: boolean; [internalGroqTypeReferenceTo]?: 'product' }
    quantity?: number
  ...
  customer?: { _ref: string; _type: 'reference'; _weak?: boolean; [internalGroqTypeReferenceTo]?: 'customer' }
  clerkUserId?: string
  email?: string
  address?: {
    name?: string
...
export type Product = {
  ...
  description?: string
  price?: number
  category?: { _ref: string; _type: 'reference'; _weak?: boolean; [internalGroqTypeReferenceTo]?: 'category' }
...
export type Slug = { _type: 'slug'; current?: string; source?: string }
...
export type Geopoint = { _type: 'geopoint'; lat?: number; lng?: number; alt?: number }
...
// Source: ./sanity/lib/groq-query/categories.ts
...
export type ALL_CATEGORIES_QUERYResult = Array<{
  ...
  title: string | null
  slug: string | null
  image: { asset: { _id: string; url: string | null } | null; hotspot: SanityImageHotspot | null } | null
}>
...
// Source: ./sanity/lib/groq-query/customers.ts
...
// Source: ./sanity/lib/groq-query/orders.ts
...
// Query: *[  _type == "order"  && _id == $id  && clerkUserId == $clerkUserId][0] {  _id,  orderNumber,  clerkUserId,  email,  items[]{    _key,    quantity,    priceAtPurchase,    product->{      _id,      name,      "slug": slug.current,      "image": images[0]{        asset->{          _id,          url        }      }    }  },  total,  status,  address{    name,    line1,    line2,    city,    postcode,    country  },  stripePaymentId,  createdAt}
...
export type ORDER_BY_STRIPE_PAYMENT_ID_QUERYResult = { _id: string } | null

// Source: ./sanity/lib/groq-query/products.ts
...
export type FILTER_PRODUCTS_BY_NAME_QUERYResult = Array<{
  ...
  slug: string | null
  price: number | null
  images: Array<{ _key: string; asset: { _id: string; url: string | null } | null }> | null
  category: { _id: string; title: string | null; slug: string | null } | null
  material: 'fabric' | 'glass' | 'leather' | 'metal' | 'wood' | null
  color: 'black' | 'grey' | 'natural' | 'oak' | 'walnut' | 'white' | null
  stock: number | null
...
// Source: ./sanity/lib/groq-query/stats.ts
